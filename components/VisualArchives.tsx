...
export default function VisualArchives() {
  return (
    <section id="gallery" className="relative py-24 bg-[#07040D]">
          ...
          {archives.map((item, i) => (
            ...
            >
              <Tilt maxTilt={6} className="h-full">
                <div className="relative rounded-2xl overflow-hidden bg-[#0F091A] border border-purple-500/30 group h-72 flex flex-col justify-end p-6 shadow-[0_0_20px_rgba(168,85,247,0.15)]">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#07040D] via-[#07040D]/40 to-transparent z-10" />
