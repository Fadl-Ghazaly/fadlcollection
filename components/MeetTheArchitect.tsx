...
export default function MeetTheArchitect() {
  return (
    <section id="about" className="relative py-24 bg-[#07040D]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full max-w-sm">
              ...
              <div className="relative p-3 rounded-2xl bg-[#0F091A] border-2 border-purple-500/30 shadow-[0_0_40px_rgba(168,85,247,0.2)]">
                ...
                <div className="mt-3 text-center">
                  ...
                  <p className="text-[11px] font-mono text-purple-300">MAHASISWA TRPL · POLITEKNIK IDN</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div>
              <p className="text-xs font-mono tracking-widest uppercase text-fuchsia-400 mb-3">
                SYSTEM ARCHITECT &amp; DEVELOPER
              </p>
              <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight mb-6">
                MEET THE ARCHITECT.
              </h2>
              <blockquote className="text-zinc-300 text-sm md:text-base leading-relaxed italic border-l-2 border-purple-500 pl-4 mb-6 bg-[#0F091A]/80 p-4 rounded-r-xl">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-purple-500/20">
              <div className="p-4 rounded-xl bg-[#0F091A] border border-purple-500/30 text-center">
                <div className="text-2xl md:text-3xl font-black text-purple-400">5+</div>
